        ...
        >
          <SwiperSlide className=" pb-16">
            ...
            <div className="flex justify-center gap-x-6 lg:gap-x-10">
              {FamilyData.slice(2, 5).map((item, index) => (
                <motion.div // Animate each family member card
                  key={index}
                  className="relative inline-block w-20 h-20 lg:w-60 lg:h-60"
          ...
          <SwiperSlide className="pb-16">
            ...
            <div className="flex justify-center gap-x-10 border-">
              {FamilyData.slice(5, 8).map((item, index) => (
                <motion.div
                  key={index}
                  className="relative inline-block  w-20 h-20 lg:w-60 lg:h-60"
                  variants={cardVariants} // Set animation variants
          ...
          <SwiperSlide className="pb-16">
            {" "}
            <div className="flex justify-center gap-x-10 border-">
              {FamilyData.slice(9, 13).map((item, index) => (
                <motion.div
                  key={index}
                  className="relative inline-block  w-20 h-20 lg:w-60 lg:h-60"
                  variants={cardVariants} // Set animation variants
